...
class UpdateItemStepTwo extends StatelessWidget {
  const UpdateItemStepTwo(
      {super.key,
      required this.categoryType,
      required this.titleController,
      required this.addressController,
      required this.descriptionController,
      required this.setCategoryId, required this.categoryId});
            ...
            child: Column(
              children: [
                ...
                DropdownButtonFormField<int>(
                  ...
                  value: categoryId, // You can set the initial value here
                  onChanged: (int? value) {
